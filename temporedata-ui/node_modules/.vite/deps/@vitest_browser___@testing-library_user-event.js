...
function normalizeFormat(format) {
  const type3 = toAsciiLowercase(format);
  return type3 === "text" ? "text/plain" : type3 === "url" ? "text/uri-list" : type3;
}
...
function createDataTransferStub(window) {
  return new class DataTransferStub {
    getData(format) {
      ...
      const type3 = normalizeFormat(format);
      const match = (_this_items_find = this.items.find(getTypeMatcher(type3, true))) !== null && _this_items_find !== void 0 ? _this_items_find : this.items.find(getTypeMatcher(type3, false));
      let text = "";
    ...
    setData(format, data) {
      const type3 = normalizeFormat(format);
      const matchIndex = this.items.findIndex(getTypeMatcher(type3, true));
      const item = new DataTransferItemStub(data, type3);
      if (matchIndex >= 0) {
  ...
  End: (event, target) => {
    if (isElementType(target, [
      ...
      return () => {
        ...
        const newPos = (_ref = (_getValueOrTextContent = getValueOrTextContent(target)) === null || _getValueOrTextContent === void 0 ? void 0 : _getValueOrTextContent.length) !== null && _ref !== void 0 ? _ref : (
          /* istanbul ignore next */
          0
        );
...
var KeyboardHost = class {
  ...
  /** Press a key */
  async keydown(instance, keyDef, repeat = false) {
